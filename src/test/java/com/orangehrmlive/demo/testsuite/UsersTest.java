...
//Verify "Add User" Text
        ...
        Assert.assertEquals(actualResult, expectedResult, "Message not displayed");
//Select User Role "Admin"
        loginPage.selectUserRole("Admin");
//enter Employee Name
        loginPage.enterEmployeeName("Smith");
//enter Username
        loginPage.enterUserName("Smith");
//Select status "Disable"
        loginPage.selectStatus("Disabled");
//enter psaaword
        loginPage.enterPassWord("Smith123");
//enter Confirm Password
        loginPage.enterConfirmPass("Smith123");
...
//Verify "System Users" Text
        ...
        //Enter Username
        adminPage.enterSysterUserName("Smith");
        //Select User Role
